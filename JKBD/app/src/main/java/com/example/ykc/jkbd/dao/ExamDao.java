        ...
        utils.url(uru).targetClass(information.class)
                .execute(new OkHttpUtils.OnCompleteListener<information>() {
                    ...
                    public void onSuccess(information result) {
                        ...
                        ExamApplication.getInsance().sendBroadcast(new Intent(ExamApplication.LOAD_EXAM_INFO)
        ...
        utils1.url(url2)
                ...
                .execute(new OkHttpUtils.OnCompleteListener<String>() {
                    ...
                    public void onError(String error) {
                        ...
                        Log.e("main","error="+error);
                        ExamApplication.getInsance().sendBroadcast(new Intent(ExamApplication.LOAD_EXAM_QUESTION)
                                .putExtra(ExamApplication.LOAD_DATA_SUCCESS,false));
                    }
                });
